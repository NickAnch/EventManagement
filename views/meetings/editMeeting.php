        ...
        <div class="card create">
          ...
          <div class="card-body">
            <?php if ($organizer[0]['creater_id'] != $userId): ?>
              <p>Вы не можете вносить изменения!</p>
            <?php else: ?>
            <?php if ($result): ?>
              <div class="alert alert-success" role="alert">Данные отредактированы!</div>
            <?php endif;?>
            <form enctype="multipart/form-data" action="" method="post" class="mapDetail needs-validation" novalidate>
              ...
              <div class="col-xl-10  col-lg-10 col-md-10 col-sm-12">
              <img src="<?php echo Meetings::getMeetImage($id)?>" width="200" alt="">
              <input name="image" type="file" class="form-control" placeholder="" >
              </div>
            </div>
              <div class="form-check ">
                <input name= "closeMeetup" type="checkbox" class="form-check-input" <?php if ($closeMeetup == 1) echo 'checked'; ?> >
