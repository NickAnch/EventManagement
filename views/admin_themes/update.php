    ...
    <div class="row justify-content">
      <div class="col-xl-6  col-lg-6 col-md-8 col-sm-12">
        ...
        <div class="card create">
          <h1 class="card-header">Изменение названия темы, ID - <?php echo $theme['id'];?></h5>
          <div class="card-body">
            <?php if ($result): ?>
              <div class="alert alert-success" role="alert">Тема изменена!</div>
            <?php endif;?>
            <form action="#" method="post" class="needs-validation" novalidate>
              ...
              <div class="form-group row">
                ...
                <div class="col-xl-10  col-lg-9 col-md-9 col-sm-12">
                  <input name= "theme" type="text" class="form-control" placeholder="Тема" value="<?php echo $interest;?>" required >
              ...
              <div class="form-group ">
                <div>
                  <button name="editTheme" type="submit" class="btn btn-success">Изменить</button>
                </div>
              </div>
            </form>
          </div>
