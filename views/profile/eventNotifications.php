...
<body>
  ...
  <div class="container">
    ...
    <ul class="nav nav-pills">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="/eventNotifications/">Оповещения</a>
      </li>
    </ul>
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
        <div class="card" >
          ...
          <div class="card-body">
            ...
            <p class="card-text"> <b>Пригласил: </b><a href="/user/<?php echo $notifItem['creater_id'];?>"><?php echo $notifItem['name'].' '.$notifItem['surname'];?></a></p>
            <a href="/meetings/<?php echo $notifItem['meeting_id']?> " class="btn btn-primary">Подробнее</a>
            <a href="#" class="btn btn-outline-danger">Удалить приглашение</a>
          </div>
        </div>
      </div>
      <?php endforeach; ?>
